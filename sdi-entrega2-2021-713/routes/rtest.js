...
module.exports = function (app, swig, gestorBD) {
    app.get('/test', function (req, res, next) {
        ...
        //Reiniciamos los chats
        gestorBD.eliminarChats({}, function (chats) {
            if (chats === null) {
                utils.manejoErrores('Error al eliminar chats de la BBDD para las pruebas',
                    'Error al eliminar chats', next);
            } else {
                                    ...
                                    if (chats === null) {
                                        ...
                                        gestorBD.insertar('mensajes', mensajes, function (mensajes) {
                                            if (mensajes === null) {
                                                ...
                                                // Este proceso puede durar tiempo
